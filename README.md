...
The repository includes: Dir named : Resources hawaii.sqlite, hawaii_measurements.csv, hawaii_stations.csv Dir name : SurfsUp climate_starter.jpynb app.py

In order to run app.py without issues please use the external gitbash terminal

Thank you

Instructions for challege Congratulations! You've decided to treat yourself to a long holiday vacation in Honolulu, Hawaii. To help with your trip planning, you decide to do a climate analysis about the area. The following sections outline the steps that you need to take to accomplish this task.
